$LOAD_PATH.unshift(File.expand_path(File.join(File.dirname(__FILE__), '../lib/vcap/upload_manager')))
$LOAD_PATH.unshift(File.expand_path(File.join(File.dirname(__FILE__), '../lib/vcap')))
