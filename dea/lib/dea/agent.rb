  ...
  class Agent
    ...
    def run()
      ...
      NATS.start(:uri => @nats_uri) do
        ...
        NATS.subscribe('cc.start') {  |msg| process_cc_start(msg) }
        ...
        NATS.publish('dea.cc.hello', { :id => uuid, :runtimes => @runtimes }.to_json)
      end
    end
    ...
    def process_cc_start(message)
      NATS.publish("dea.cc.hello", { :id => VCAP::Component.uuid, :runtimes => @runtimes }.to_json)
    end
    ...
    def shutdown()
      ...
      NATS.publish('dea.cc.goodbye', { :id => VCAP::Component.uuid }.to_json)
