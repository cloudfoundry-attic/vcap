...
describe 'Router Integration Tests (require nginx running)' do
  ...
  it 'should properly do sticky sessions' do
    ...
    # The following cookie is generated by '10.10.10.10:10'
    cookie = "__VCAP_ID__=SUfuQ+tIiv7GhGR9+R5UfPp6bmFgyhfZtdUcKEJJrQPXS2tBUxZpDg=="
    sticky_request = simple_sticky_request('sticky.vcap.me', '/sticky', cookie)

    status, body = send_http_request("127.0.0.1", RouterServer.port, sticky_request)
    status.should_not == 500
