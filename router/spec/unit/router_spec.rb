...
describe Router do
  ...
  describe 'Router.register_droplet' do
    ...
    it 'should register a droplet' do
      Router.register_droplet('foo.vcap.me', '10.0.1.22', 2222, {}, 'foo')
    ...
    it 'should count droplets independent of URL' do
      Router.register_droplet('foo.vcap.me', '10.0.1.22', 2222, {}, 'foo')
      Router.register_droplet('foo.vcap.me', '10.0.1.22', 2224, {}, 'foo')
    ...
    it 'should record tags' do
      ...
      Router.register_droplet('foobar.vcap.me', '10.0.1.22', 2225, {"component" => "test"}, 'foo')
