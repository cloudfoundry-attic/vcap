#hm2 -- HealthManager 2.0. (c) 2011-2012 VMware, Inc.
...
require 'hm2/constants'
require 'hm2/app_state_provider'
require 'hm2/nats_based_known_state_provider'
require 'hm2/bulk_based_expected_state_provider'
require 'hm2/scheduler'
require 'hm2/nudger'
require 'hm2/harmonizer'
...
module HealthManager2
  ...
  class Manager
    ...
    def initialize(config={})
      ...
      @logger.info("HM2: HealthManager2 initializing")
    ...
    def start
      ...
      NATS.start :uri => ENV['NATS_URI'] || 'nats://nats:nats@192.168.24.128:4222' do #TODO: nats_uri through config
        ...
        @scheduler.start #blocking call, starts the EM.loop
      end
    end
