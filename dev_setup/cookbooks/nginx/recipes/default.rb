...
when "ubuntu"
  ...
  nginx_patch_tarball = File.join(node[:deployment][:setup_cache], "zero_byte_in_cstr_20120315.patch")
  remote_file nginx_patch_tarball do
    owner node[:deployment][:user]
