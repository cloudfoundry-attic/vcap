...
class App < ActiveRecord::Base
  ...
  Runtimes = %w[ruby18 ruby19 java node php erlangR14B02 python26 iis]
  Frameworks = %w[sinatra rails3 java_web spring grails node php otp_rebar lift wsgi django dotNet unknown]
